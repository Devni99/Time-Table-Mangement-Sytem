...
{
    public partial class NotOverlappingSession : Form
    {
        public NotOverlappingSession()
        {
            InitializeComponent();
            populate();
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow dr in SessionDGV.Rows)
            {
                ...
                if (chkboxSelected)
                {
                    string sqlquery = "Insert into NotOverlapping values (@Lec01,@Lec02,@Code,@Subject,@GroupID,@Tag,@NumOfStu,@Duration)";
        ...
        private void NotOverlappingSession_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'timeTableDatabaseDataSet4.Session' table. You can move, or remove it, as needed.
            this.sessionTableAdapter.Fill(this.timeTableDatabaseDataSet4.Session);
        ...
        {
            ManageNotOverlappingSessions ad = new ManageNotOverlappingSessions();
            ad.Show();
            this.Hide();
        }
