...
namespace Time_Table_Mangement_Sytem {
    ...
    public partial class TImeTableDBDataSet1 : global::System.Data.DataSet {
        ...
        public partial class SessionDataTable : global::System.Data.TypedTableBase<SessionRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public SessionRow AddSessionRow(string Lecturer1, string Lecturer2, string SubjectCode, string SubjectName, string GroupID, string Tag, int NumOfStu, int Duration, System.DateTime Date) {
...
namespace Time_Table_Mangement_Sytem.TImeTableDBDataSet1TableAdapters {
    ...
    public partial class SessionTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Session] ([Lecturer1], [Lecturer2], [SubjectCode], [SubjectName], [GroupID], [Tag], [NumOfStu], [Duration], [Date]) VALUES (@Lecturer1, @Lecturer2, @SubjectCode, @SubjectName, @GroupID, @Tag, @NumOfStu, @Duration, @Date);
SELECT id, Lecturer1, Lecturer2, SubjectCode, SubjectName, GroupID, Tag, NumOfStu, Duration, Date FROM Session WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Session] SET [Lecturer1] = @Lecturer1, [Lecturer2] = @Lecturer2, [SubjectCode] = @SubjectCode, [SubjectName] = @SubjectName, [GroupID] = @GroupID, [Tag] = @Tag, [NumOfStu] = @NumOfStu, [Duration] = @Duration, [Date] = @Date WHERE (([id] = @Original_id) AND ((@IsNull_Lecturer1 = 1 AND [Lecturer1] IS NULL) OR ([Lecturer1] = @Original_Lecturer1)) AND ((@IsNull_Lecturer2 = 1 AND [Lecturer2] IS NULL) OR ([Lecturer2] = @Original_Lecturer2)) AND ((@IsNull_SubjectCode = 1 AND [SubjectCode] IS NULL) OR ([SubjectCode] = @Original_SubjectCode)) AND ((@IsNull_SubjectName = 1 AND [SubjectName] IS NULL) OR ([SubjectName] = @Original_SubjectName)) AND ((@IsNull_GroupID = 1 AND [GroupID] IS NULL) OR ([GroupID] = @Original_GroupID)) AND ((@IsNull_Tag = 1 AND [Tag] IS NULL) OR ([Tag] = @Original_Tag)) AND ((@IsNull_NumOfStu = 1 AND [NumOfStu] IS NULL) OR ([NumOfStu] = @Original_NumOfStu)) AND ((@IsNull_Duration = 1 AND [Duration] IS NULL) OR ([Duration] = @Original_Duration)) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)));
SELECT id, Lecturer1, Lecturer2, SubjectCode, SubjectName, GroupID, Tag, NumOfStu, Duration, Date FROM Session WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Lecturer1, Lecturer2, SubjectCode, SubjectName, GroupID, Tag, NumOfStu" +
                ", Duration, Date FROM dbo.Session";
        ...
        public virtual int Delete(int Original_id, string Original_Lecturer1, string Original_Lecturer2, string Original_SubjectCode, string Original_SubjectName, string Original_GroupID, string Original_Tag, global::System.Nullable<int> Original_NumOfStu, global::System.Nullable<int> Original_Duration, global::System.Nullable<global::System.DateTime> Original_Date) {
        ...
        public virtual int Insert(string Lecturer1, string Lecturer2, string SubjectCode, string SubjectName, string GroupID, string Tag, global::System.Nullable<int> NumOfStu, global::System.Nullable<int> Duration, global::System.Nullable<global::System.DateTime> Date) {
            if ((Lecturer1 == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_Lecturer1 == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_Lecturer1));
            }
            if ((Original_Lecturer2 == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((string)(Original_Lecturer2));
            }
            if ((Original_SubjectCode == null)) {
            ...
            if ((Original_GroupID == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[19].Value = ((string)(Original_GroupID));
            }
            if ((Original_Tag == null)) {
            ...
            if ((Original_NumOfStu.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[23].Value = ((int)(Original_NumOfStu.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<int> Original_Duration, 
                    global::System.Nullable<global::System.DateTime> Original_Date) {
            return this.Update(Lecturer1, Lecturer2, SubjectCode, SubjectName, GroupID, Tag, NumOfStu, Duration, Date, Original_id, Original_Lecturer1, Original_Lecturer2, Original_SubjectCode, Original_SubjectName, Original_GroupID, Original_Tag, Original_NumOfStu, Original_Duration, Original_Date, Original_id);
        }
    }
