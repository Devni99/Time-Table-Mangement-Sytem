    ...
    public partial class ParallelSession : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow dr in SessionDGV.Rows)
            {
                ...
                if (chkboxSelected)
                {
                    string sqlquery = "Insert into ParallelSession values (@Lec01,@Lec02,@Code,@Subject,@GroupID,@Tag,@NumOfStu,@Duration)";
        ...
        {
            // TODO: This line of code loads data into the 'timeTableDatabaseDataSet3.Session' table. You can move, or remove it, as needed.
            this.sessionTableAdapter.Fill(this.timeTableDatabaseDataSet3.Session);
        ...
        {
            ManageParallel mc = new ManageParallel();
            mc.Show();
            this.Hide();
        }
